...
class Config:
    ...
    GEMINI_MODEL_NAME     = "models/gemini-2.5-flash"         # Or other Gemini models like "gemini-1.5-pro-latest"
    ...
    HUGGINGFACE_API_KEY = "YOUR_HUGGINGFACE_API_KEY" # IMPORTANT: Replace with your actual Hugging Face API token
    HUGGINGFACE_MODEL_NAME = "meta-llama/Llama-3.3-70B-Instruct" # Hugging Face model
